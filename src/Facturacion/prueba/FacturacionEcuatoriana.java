 ...
 */
package Facturacion.prueba;
import Facturacion.model.*;
import Facturacion.util.ClaveAccesoGenerator;
import Facturacion.util.DateFormatter;
import Facturacion.util.XMLBuilder;
import Facturacion.util.XMLStreamer;
import Facturacion.sign.XAdESSIgner;
import Facturacion.sri.SRIReceiverClient;
import Facturacion.sri.SRIAuthorizerClient;
...
public class FacturacionEcuatoriana {
    ...
    public static void main(String[] args) {
        try {
            ...
            Facturacion.sign.XAdESSIgner signer = new XAdESSIgner(P12_PATH, P12_PASSWORD);
